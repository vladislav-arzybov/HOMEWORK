# Домашнее задание к занятию 5 «Тестирование roles» - `Арзыбов Владислав`
...
[1.2.0](https://github.com/vladislav-arzybov/vector-role/commit/e1488f4f5562b3825e3a43d28def312b4625616b)

После выполнения у вас должно получится два сценария molecule и один tox.ini файл в репозитории. Не забудьте указать в ответе теги решений Tox и Molecule заданий. В качестве решения пришлите ссылку на  ваш репозиторий и скриншоты этапов выполнения задания. 

![изображение](https://github.com/user-attachments/assets/0a0d431e-5181-4401-a9c7-b5e7a6025a9f)
