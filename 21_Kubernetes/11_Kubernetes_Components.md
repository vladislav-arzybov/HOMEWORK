...
С учетом округления ресурсов на каждую из 3х worker нод потребуется 21 Гб ОЗУ и 11 ядер ЦПУ. Для master нод в количестве 3х штук потребуется по 2 Гб ОЗУ и 2 ядера ЦПУ на каждую.
...
С учетом округления ресурсов на каждую из 5ти worker нод потребуется 11 Гб ОЗУ и 7 ядер ЦПУ

Сравним их стоимость на примере YandexCloud
