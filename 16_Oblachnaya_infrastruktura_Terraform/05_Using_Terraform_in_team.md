...
variable "test2" {
  ...
  validation {
    condition = alltrue([ for ip in var.test2 : can(regex("^((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])$", ip))])
    error_message = "ERROR: Invalid ip list!"
  }
}
```

![изображение](https://github.com/user-attachments/assets/b8deb736-b7fd-4b49-895e-7226be9dadde)
