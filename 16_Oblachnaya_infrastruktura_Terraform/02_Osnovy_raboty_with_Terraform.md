# Домашнее задание к занятию «Основы Terraform. Yandex Cloud» - `Арзыбов Владислав`
...
![изображение](https://github.com/user-attachments/assets/b5b1b231-0ab4-4887-86aa-5112c60abc08)

5. Подключитесь к консоли ВМ через ssh и выполните команду ``` curl ifconfig.me```.
Примечание: К OS ubuntu "out of a box, те из коробки" необходимо подключаться под пользователем ubuntu: ```"ssh ubuntu@vm_ip_address"```. Предварительно убедитесь, что ваш ключ добавлен в ssh-агент: ```eval $(ssh-agent) && ssh-add``` Вы познакомитесь с тем как при создании ВМ создать своего пользователя в блоке metadata в следующей лекции.;

![изображение](https://github.com/user-attachments/assets/4ceb3900-0338-4685-b978-0a4b556ef5b6)


6. Ответьте, как в процессе обучения могут пригодиться параметры ```preemptible = true``` и ```core_fraction=5``` в параметрах ВМ.

- preemptible = true - останавливает ВМ через 24 часа, для экономии средств.
- core_fraction=5 - производительность ядра в процентах, для экономии средств.
...
- [variables.tf](https://github.com/vladislav-arzybov/HOMEWORK/blob/main/16_Oblachnaya_infrastruktura_Terraform/variables.tf_2_2)
...
![изображение](https://github.com/user-attachments/assets/7b9b2f14-6739-4ec1-92bd-6ca5e5cfd437)
