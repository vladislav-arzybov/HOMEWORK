Необходимо удалить отдельный репозиторий с дипломом, обновить терраформ, и по новой добавить lb с новой веткой, также сделать статичный ip и убрать внешние адреса у воркер нод
