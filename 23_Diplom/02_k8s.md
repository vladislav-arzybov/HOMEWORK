...
```
текстовка успешного выполнения задач
```

> После успешного выполнения первого этапа первичной настройки матстер ноды появится сообщение инструкцией по дальнейшим действиям на удаленном сервере, запуске kubespray.

Cкрин окна в ансибле
Скрин установки кластера
