...
<img width="1342" height="338" alt="изображение" src="https://github.com/user-attachments/assets/2917c29f-4658-4426-b25d-b2cfd8a4fde1" />
...
masters = {
  "master-node-1" = {
    "external_ip" = "158.160.49.136"
    "internal_ip" = "10.0.1.14"
  }
}
workers = {
  "worker-node-1" = {
    "external_ip" = "158.160.17.205"
    "internal_ip" = "10.0.2.22"
  }
  "worker-node-2" = {
    "external_ip" = "158.160.209.72"
    "internal_ip" = "10.0.3.9"
  }
}
```
